    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="quanxianApp.jobHistory.home.createOrEditLabel">
              <Translate contentKey="quanxianApp.jobHistory.home.createOrEditLabel">Create or edit a JobHistory</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : jobHistoryEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="startDateLabel" for="job-history-startDate">
                    <Translate contentKey="quanxianApp.jobHistory.startDate">Start Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="endDateLabel" for="job-history-endDate">
                    <Translate contentKey="quanxianApp.jobHistory.endDate">End Date</Translate>
                  </Label>
                  <AvInput
                ...
                <AvGroup>
                  <Label id="languageLabel" for="job-history-language">
                    <Translate contentKey="quanxianApp.jobHistory.language">Language</Translate>
                  </Label>
                  <AvInput
                  ...
                  >
                    <option value="FRENCH">{translate('quanxianApp.Language.FRENCH')}</option>
                    <option value="ENGLISH">{translate('quanxianApp.Language.ENGLISH')}</option>
                    <option value="SPANISH">{translate('quanxianApp.Language.SPANISH')}</option>
                  </AvInput>
                </AvGroup>
                <AvGroup>
                  <Label for="job-history-job">
                    <Translate contentKey="quanxianApp.jobHistory.job">Job</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="job-history-department">
                    <Translate contentKey="quanxianApp.jobHistory.department">Department</Translate>
                  </Label>
                ...
                <AvGroup>
                  <Label for="job-history-employee">
                    <Translate contentKey="quanxianApp.jobHistory.employee">Employee</Translate>
                  </Label>
