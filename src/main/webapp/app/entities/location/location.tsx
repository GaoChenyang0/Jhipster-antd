    ...
    return (
      <div>
        <h2 id="location-heading">
          <Translate contentKey="quanxianApp.location.home.title">Locations</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="quanxianApp.location.home.createLabel">Create new Location</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('quanxianApp.location.home.search')}
                  />
        ...
        <div className="table-responsive">
          {locationList && locationList.length > 0 ? (
            <Table responsive>
              <thead>
                <tr>
                  ...
                  <th>
                    <Translate contentKey="quanxianApp.location.streetAddress">Street Address</Translate>
                  </th>
                  <th>
                    <Translate contentKey="quanxianApp.location.postalCode">Postal Code</Translate>
                  </th>
                  <th>
                    <Translate contentKey="quanxianApp.location.city">City</Translate>
                  </th>
                  <th>
                    <Translate contentKey="quanxianApp.location.stateProvince">State Province</Translate>
                  </th>
                  <th>
                    <Translate contentKey="quanxianApp.location.country">Country</Translate>
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="quanxianApp.location.home.notFound">No Locations found</Translate>
            </div>
          )}
        </div>
      </div>
