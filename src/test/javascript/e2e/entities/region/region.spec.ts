...
describe('Region e2e test', () => {
  ...
  it('should load create Region page', async () => {
    ...
    expect(await regionUpdatePage.getPageTitle().getAttribute('id')).to.match(/quanxianApp.region.home.createOrEditLabel/);
  ...
  it('should delete last Region', async () => {
    ...
    expect(await regionDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/quanxianApp.region.delete.question/);
